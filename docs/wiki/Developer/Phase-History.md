...
This is a contributor-oriented evolution map. It summarizes architectural milestones through Phase 36 without requiring every phase report to be read first.
