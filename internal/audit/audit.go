...
const (
	...
	ActionIdentityUserCreated        = "identity.user_created"
	ActionIdentityUserDisabled       = "identity.user_disabled"
	ActionIdentityUserEnabled        = "identity.user_enabled"
	ActionIdentityCapabilityGranted  = "identity.capability_granted"
	ActionIdentityCapabilityRevoked  = "identity.capability_revoked"
	ActionIdentityMagicTokenIssued   = "identity.magic_token_issued"
	ActionIdentityMagicTokenConsumed = "identity.magic_token_consumed"
	ActionIdentityMagicTokenExpired  = "identity.magic_token_expired"
	ActionIdentityMagicTokenRevoked  = "identity.magic_token_revoked"
	ActionIdentitySelfLockoutPrevent = "identity.self_lockout_prevented"
	ActionMagicTokenSuccess          = "auth.magic_token_success"
	ActionMagicTokenFailure          = "auth.magic_token_failure"
	ActionPasswordDeniedNonSuper     = "auth.password_denied_non_super_admin"
)
